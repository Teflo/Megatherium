 ...
 * @author marti_000
 */
public class ResourceSelectionPanel extends EventPanel {
	private Map<String, String> amounts = new HashMap<String, String>();

	/**
	 * Creates new form ResourceSelectionPanel
	 */
	...
	public void setHabitat(Habitat habitat) {
		ResourceTableModel model = new ResourceTableModel(habitat.getResources());
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
		this.amounts = ((ResourceTableModel) this.jTable1.getModel()).getAmounts();
		EventManager.getInstance().fireEvent("lordsandknights.ui.resource.selection.save", this.amounts);
    }//GEN-LAST:event_saveActionPerformed

    private void cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelActionPerformed
		EventManager.getInstance().fireEvent("lordsandknights.ui.resource.selection.cancel");
